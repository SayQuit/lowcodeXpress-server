...
async function selectJSON(account, id) {
    const selectSQL = `select createAt, id, name, description, type, tech, lib, lastModified, variable, element, event, props from project where account = '${account}' and id = '${id}'`
